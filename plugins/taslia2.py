...
async def permalink_heno(c, msg):
    heno = ['ولك وجة سطل سكت وحسلك🔥🧐😂', 'بس يآبطيخه اخرس خآلص 🤫']
    if not msg.reply_to_message:
        return
    if msg.reply_to_message.from_user.id == 5917983447:
...
async def bZEra_1(c, msg):
    animation_interval = 2
    animation_ttl = range(6)
    event = await c.send_message(msg.chat.id, "جميع ألوان البشره يكلبي  - ❤.")
    animation_chars = ["😁🏿", "😁🏾", "😁🏽", "😁🏼", "‎😁", "**#بباي....**"]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await msg.edit(animation_chars[i % 6])
...
async def monkey_1(c, msg):
    ...
    event = await c.send_message(msg.chat.id, "خد قرود يكلبي  🤗😂")
    animation_chars = ["🐵", "🙉", "🙈", "🙊", "🖕‎🐵🖕", "**بباي...**"]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await msg.edit(animation_chars[i % 6])
...
@Client.on_message(filters.command(["ZE", "سورس 𓀛 الفراعنة𓀛", "السورس"], ".") & filters.me)
async def gajjajay(client: Client, message: Message):
    ...
    await message.edit("🔥🔥🔥")
    await asyncio.sleep(0.3)
    await message.edit("سورس 𓀛 الفراعنة𓀛 راح يشتغل  🥹❤️")
...
async def knasas(client: Client, message: Message):
    ...
    animation_ttl = range(6)
    animation_chars = [
        "_/﹋\\_\n" "(҂`_´)\n" "<,︻╦╤─ ҉\n" r"_/﹋\_" "\n اثبت مكانك انت عبالك هيتة لو شنو اوكف وذب هدومك ولك  🧐😂 ??!",
    ]
    if message.forward_from:
        return
...
async def anthar(client: Client, message: Message):
    ...
    if message.forward_from:
        return
    await message.edit("كافي مليت من حيآتي جآري الانتحارر ...")
    await asyncio.sleep(4)
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await message.edit(animation_chars[i % 6])
...
@Client.on_message(filters.command("اركض", ".") & filters.me)
async def agryy(client: Client, message: Message):
    ...
    if message.forward_from:
        return
    await message.edit("يلآ انا راح اركض. لي يلزمني يكسرني 🧐😂 ...")
    await asyncio.sleep(4)
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await message.edit(animation_chars[i % 6])
...
async def likenice(client: Client, message: Message):
    ...
    if message.forward_from:
        return
    await message.edit("جآري رزع افخم لآيك ع الابب يكلبي  💋❤ ...")
    await asyncio.sleep(4)
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await message.edit(animation_chars[i % 6])
...
async def dbabaa(client: Client, message: Message):
    ...
    if message.forward_from:
        return
    await message.edit("افتح طريق راح افجركم بل دبابة مالتي  🤫😂 ...")
    await asyncio.sleep(4)
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await message.edit(animation_chars[i % 6])
...
async def hanzer(client: Client, message: Message):
    ...
    if message.forward_from:
        return
    await message.edit("يلآ راح اروح اطبخلك خنزير عل عشاء  😎😂")
    await asyncio.sleep(4)
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await message.edit(animation_chars[i % 6])
...
async def klbklab(client: Client, message: Message):
    ...
    if message.forward_from:
        return
    await message.edit("اخذ حبيبي اضخم كلب بيتبول ليك - 🐕")
    await asyncio.sleep(4)
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await message.edit(animation_chars[i % 6])
...
async def fela(client: Client, message: Message):
    ...
    if message.forward_from:
        return
    await message.edit("وسع وسع الفيل مالتي جاي  - 🐘")
    await asyncio.sleep(4)
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await message.edit(animation_chars[i % 6])   
...
async def hak(client: Client, message: Message):
  ...
  asyncio.sleep(2)
  await message.edit_text("۞︙  تـم اخـتراق الضـحية..\n\nقـم بالـدفع الى سورس 𓀛 الفراعنة𓀛 لعـدم نشـر معلوماتك وصـورك")
